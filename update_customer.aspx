<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update_customer.aspx.cs" Inherits="CMS_EnDe.update_customer" %>
...
<body>
    <form id="form1" runat="server">
        <div style="text-align:center;">
            <h1 style="color:#336666">修改顧客資料</h1>
            <p>
            ...
            <p>
                <asp:Label ID="label_confirm" runat="server" Text="請再次確認修改內容!" ForeColor="Red" Visible="False"></asp:Label>
            </p>       
            <p>
                <asp:Button ID="button_cancel" runat="server" Text="取消" OnClick="button_cancel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="button_submit" runat="server" Text="確認" OnClick="button_submit_Click" />
            </p>
        </div>
    </form>
</body>
